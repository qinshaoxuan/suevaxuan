...
/* START MAIN */ 
	...
	array( "name" => __( "评论声明","wip"),
	       "desc" => __( "是否开启评论声明?","wip"),
	       "class" => "hidden",
	       "id" => $shortname."_view_comments_declaraction",
	       "type" => "on-off",
	       "std" => "off"),

	array( "name" => __( "评论声明内容","wip"),
	       "desc" => __( "输入评论声明内容，将放在评论区下方","wip"),
	       "id" => $shortname."_comments_declaraction_text",
	       "type" => "textarea",
	       "std" => ""),
...
/* START FOOTER */ 
	...
	array( "name" => __( "Twitter Url","wip"),
	       "desc" => __( "输入 Twitter Url (隐藏图标则为空)","wip"),
	       "id" => $shortname."_footer_twitter_button",
	       "type" => "text",
	       "std" => ""),

	array( "name" => __( "Flickr Url","wip"),
	       "desc" => __( "输入 Flickr Url (隐藏图标则为空)","wip"),
