...
consoleRender.prototype.init = function(game){
	...
	console.log('欢迎访问 %cxuan\'s blog%c, 这是一个可以在console玩的2048~','color:blue;font-weight:bold;','');

	console.log('将你的console停靠在主窗口, 然后点击页面（不是console）来让脚本可以捕获按键');

    var args = [
        '按下 %cENTER%c 来开始游戏 ，使用 %c方向键%c 或者 %cWASD%c 来玩吧~'
